...
function Register (){
	...
	$yytitle = "$txt[97]";
	$publickey = "6LeeEwMAAAAAAJALLoxovTMIUtoR4gK7Jxc1Qixz";
	template_header();
	print <<<EOT
...
function Register2 () {
	...
	$privatekey = "6LeeEwMAAAAAAMDSP1VGpLeV-wuGVlp_J1TJMBzU";
	...
	if (!$resp->is_valid) {
	  fatal_error ("The reCAPTCHA wasn't entered correctly. Go back and try it again.");
	}
